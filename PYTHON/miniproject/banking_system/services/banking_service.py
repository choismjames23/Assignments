...
from banking_system.utils.exceptions import UserNotFoundError , InsufficientFundsError , NegativeAmountError
...
class BankingService:
    ...
    def user_menu(self, username: str) -> None:
        ...
        while True:
            try:
                choice = input("원하는 작업을 선택하세요(1:입금 2:출금 3:잔고확인 4:거래내역 5:종료): ")
                if choice == '1':
